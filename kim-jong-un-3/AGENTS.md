# Kim Jong Un 3 Addon Instructions

- Keep changes compatible with PaperMC APIs and Nova addon APIs.
- Follow existing formatting and style in this addon.
- Use uk.co.xfour.kimjongun3 as the base package.
